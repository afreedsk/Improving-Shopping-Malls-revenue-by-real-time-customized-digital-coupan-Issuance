"""improving_shopping_mall_revenue URL Configuration
...
from improving_shopping_mall_revenue import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Revenue_Type/$', remoteuser.Predict_Revenue_Type, name="Predict_Revenue_Type"),
    ...
    url(r'^View_Prediction_Of_Revenue_Type_Ratio/$', serviceprovider.View_Prediction_Of_Revenue_Type_Ratio, name="View_Prediction_Of_Revenue_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Revenue_Type/$', serviceprovider.View_Prediction_Of_Revenue_Type, name="View_Prediction_Of_Revenue_Type"),
