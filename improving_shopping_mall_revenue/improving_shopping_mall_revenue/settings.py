...
ROOT_URLCONF = 'improving_shopping_mall_revenue.urls'
...
WSGI_APPLICATION = 'improving_shopping_mall_revenue.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'improving_shopping_mall_revenue',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
