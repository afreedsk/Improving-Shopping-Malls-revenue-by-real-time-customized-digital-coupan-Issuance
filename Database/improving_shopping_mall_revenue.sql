...
--
-- Host: localhost
-- Generation Time: Sep 13, 2023 at 08:14 AM
...
--
-- Database: `improving_shopping_mall_revenue`
--
CREATE DATABASE IF NOT EXISTS `improving_shopping_mall_revenue` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `improving_shopping_mall_revenue`;
...
('1rydt56cnu7pa2r3lyi07m4egk8br2z1', 'eyJ1c2VyaWQiOjJ9:1qeFCp:Yc4qax8nJZnvD1gfqXEa0P-Uk5hQ8h73QifINvIJw4c', '2023-09-21 13:37:59.969944'),
...
('cdi8onno0ip5wv0qbsrsovp5ex0ozsez', 'eyJ1c2VyaWQiOjF9:1qeEFP:kd_VEOslHCgVn8Yy7w7WXiPmWQpsTbSorkd9W8dXfXU', '2023-09-21 12:36:35.640540'),
...
('fxp8eqnyd190muf8qa7oogf1cjtl2uc7', 'eyJ1c2VyaWQiOjF9:1oTeAU:e8-Me0sigk2QWW_-Vnuqf9zaGnuH4LDhLEQOV0qVbLs', '2022-09-15 06:59:14.473715'),
('gm9qswlvwsd2lakzw75ohxudd6le07id', 'eyJ1c2VyaWQiOjJ9:1oTfYk:Do9sKYGz_kzwE1ueFxy2acHfPYaYR00sI_4cXcZKs7Q', '2022-09-15 08:28:22.789766'),
...
(1, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore'),
...
(22, 'Recurrent Neural Network-RNN', '47.4'),
(23, 'SVM', '50.8'),
(24, 'Logistic Regression', '51.2'),
(25, 'Decision Tree Classifier', '51.2');
...
--
-- Table structure for table `remote_user_predict_revenue`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_revenue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Tid` varchar(300) NOT NULL,
  `coupon_no` varchar(300) NOT NULL,
  ...
  `invoice_date` varchar(300) NOT NULL,
  `shopping_mall` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `remote_user_predict_revenue`
--

INSERT INTO `remote_user_predict_revenue` (`id`, `Tid`, `coupon_no`, `customer_id`, `gender`, `age`, `category`, `quantity`, `price`, `payment_method`, `invoice_date`, `shopping_mall`, `Prediction`) VALUES
(1, '172.217.6.228-10.42.0.211-443-44763-6', 'coupon_173702', 'C988172', 'Female', '66', 'Shoes', '5', '3000.85', 'Credit Card', '16-05-21', 'Metropol AVM', 'Low'),
(2, '10.42.0.211-10.42.0.1-58632-53-17', 'coupon_139207', 'C191708', 'Female', '29', 'Books', '1', '15.15', 'Credit Card', '28-10-22', 'Emaar Square Mall', 'High'),
(3, '10.42.0.42-106.39.162.36-49602-80-6', 'coupon_752693', 'C306662', 'Female', '48', 'Cosmetics', '3', '121.98', 'Cash', '28-04-22', 'Metrocity', 'Low'),
(4, '172.217.1.174-10.42.0.42-443-52963-6', 'coupon_304265', 'C653385', 'Female', '22', 'Books', '5', '75.75', 'Debit Card', '13-06-21', 'Forum Istanbul', 'Low'),
(5, '220.170.182.31-10.42.0.211-443-43609-6', 'coupon_399563', 'C250673', 'Female', '38', 'Toys', '1', '35.84', 'Cash', '24-06-21', 'Metropol AVM', 'High');
